...
If clothing reference images are provided, do not over-describe every visible item in every shot. Use text to lock only the things models often drift on:

- short boxy heavyweight T-shirt, not longline
- hem ends around the upper hip or just below the waistband, not below the crotch
- straight square body, dropped shoulders, relaxed sleeve opening
...
Avoid saying only "oversized T-shirt" because many models will make it too long, too soft, or dress-like.
...
- garment: longline T-shirt, dress-like T-shirt, tucked-in shirt, tight fitted shirt, wrong hem position, stretched print, melted print, warped text, changing pants, changing shoes, changing jewelry, plastic fabric
